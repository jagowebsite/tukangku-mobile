...
class _ReportServiceState extends State<ReportService> {
  ...
  void onScroll() {
    ...
    if (currentScroll == maxScroll && !_hasReachMax) {
      print('iam scrolling');
      reportBloc.add(GetReportService(10, false));
    }
  }

  Future<void> _refresh() async {
    await Future.delayed(Duration(seconds: 1));
    reportBloc.add(GetReportService(10, true));
    print('Refresing...');
  }
  ...
  Future<void> _showMyDialog() async {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Download Excel Laporan Jasa'),
